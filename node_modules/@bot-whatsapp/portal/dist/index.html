...
<body lang="en"><!--qv q:id=4 q:key=AKet:pq_1--><!--qv q:id=5 q:key=dyI7:-->
    <main><!--qv q:sstyle=⭐️csou2o-0 q:id=6 q:key=rUlp:3N_0-->
        ...
        <header class="⭐️csouclass=" 2o-0>
            <div ⭐️csou2o-0 logo><a href="" target="_blank" title="qwik"
                    ...
                    <div width="40" height="40"
                        ...
                        target="_blank" class="⭐️csou2o-0">
                </a></li>
                <li class="⭐️csou2o-0"><a
                        href="https://www.youtube.com/watch?v=1u0TTbjK5bo&amp;list=PL_WGMLcL4jzViIlmyDZPnhAdkc8RXGkFh"
                        target="_blank" class="⭐️csou2o-0"></a></li>
                </ul>
        </header><!--/qv-->
        <section class="hero"><!--qv q:s q:sref=5 q:key=--><!--qv q:sstyle=⭐️u1r52n-0 q:id=8 q:key=4uCQ:-->
            <div class="contenido-hero">
                <h1 class="titulo">vip on streaming</h1>
                <style>
                    .titulo {
                ...
                <style>
                    .hero{
                        background-image: url(./img/gente-viendo-TV.jpg);
                ...
                <div class="⭐️u1r52n-0 page">
                    <div class="⭐️u1r52n-0 qr-section"><!--qv q:sstyle=⭐️ehnnvv-0 q:id=9 q:key=rghJ:UZ_0-->
                        ...
                        <div class="⭐️ehnnvv-0" on:qvisible="q-72f8ccfb.js#_hW[0]" q:id="a"><img width="350" height="250"
